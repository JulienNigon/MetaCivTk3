...
public class Initialiseur {
	...
	public Initialiseur(){
		...
		if (terrains.size() == 0){
			/*Si il n'y a aucun terrain disponible, un terrain pas défaut est créé*/
		...
		/*On transmet les informations à la classe de configuration*/
		...
		System.out.println("Lecture des paramètres de la simulation");
	...
	/*Retourne la valeur du premier champ passé en paramètre rencontré*/
